...
var Reveal = (function() {
    ...
    var SLIDES_SELECTOR = '.reveal .slides section',
        ...
        supports3DTransforms = 'WebkitPerspective' in document.body.style || 'MozPerspective' in document.body.style || 'msPerspective' in document.body.style || 'OPerspective' in document.body.style || 'perspective' in document.body.style,

        // Detect support for CSS 2D transforms
        supports2DTransforms = 'WebkitTransform' in document.body.style || 'MozTransform' in document.body.style || 'msTransform' in document.body.style || 'OTransform' in document.body.style || 'transform' in document.body.style,
    ...
    function setupDOM() {
        ...
        if (!dom.wrapper.querySelector('.controls')) {
            ...
            controlsElement.innerHTML = '<div class="navigate-left"></div>' + '<div class="navigate-right"></div>' + '<div class="navigate-up"></div>' + '<div class="navigate-down"></div>';
    ...
    function createBackgrounds() {
        ...
        toArray(document.querySelectorAll(HORIZONTAL_SLIDES_SELECTOR))
    ...
    function openPreview(url) {
        ...
        dom.preview.querySelector('iframe')
            .addEventListener('load', function(event) {
            dom.preview.classList.add('loaded');
        }, false);

        dom.preview.querySelector('.close')
            .addEventListener('click', function(event) {
            closePreview();
            event.preventDefault();
        }, false);

        dom.preview.querySelector('.external')
            .addEventListener('click', function(event) {
            closePreview();
        }, false);
    ...
    function slide(h, v, f, o) {
        ...
        if (typeof f !== 'undefined') {
            ...
            toArray(fragments)
                .forEach(function(fragment, indexf) {
                if (indexf < f) {
        ...
        if (previousSlide) {
            ...
            // Issue: #285
            if (document.querySelector(HOME_SLIDE_SELECTOR)
    ...
    function updateProgress() {
        ...
        if (config.progress && dom.progress) {
            ...
            var totalCount = document.querySelectorAll(SLIDES_SELECTOR + ':not(.stack)')
                .length;
            var pastCount = 0;
    ...
    function updateBackground() {
        ...
        toArray(dom.background.childNodes)
            ...
            toArray(backgroundh.childNodes)
    ...
    function navigatePrev() {
        ...
        if (previousFragment() === false) {
            if (availableRoutes()
                ...
                if (previousSlide) {
                    var v = (previousSlide.querySelectorAll('section')
                        .length - 1) || undefined;
                    var h = indexh - 1;
                    slide(h, v);
                }
    ...
    function navigateNext() {
        ...
        if (nextFragment() === false) {
            availableRoutes()
                .down ? navigateDown() : navigateRight();
        }
    ...
    function onProgressClicked(event) {
        ...
        var slidesTotal = toArray(document.querySelectorAll(HORIZONTAL_SLIDES_SELECTOR))
            .length;
